...
function findEmployeeById(employeeId) {
    ...
    function findEmployeeBySpecilization(specialization) {
        const foundEmployeeSpec = employees.find(employee => employee.spec === specialization);
        if (foundEmployeeSpec) {
            document.getElementById('employeesDetails').innerHTML = 
            `<p>${foundEmployeeSpec.id}: ${foundEmployeeSpec.name} - ${foundEmployeeSpec.department} - ${foundEmployeeSpec.spec}</p>`;
        } else {
